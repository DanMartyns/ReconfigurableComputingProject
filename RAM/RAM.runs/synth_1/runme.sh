...
HD_PWD='/home/danielmartins/Documentos/Universidade/CR/Projecto/RAM/RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAMWrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAMWrapper.tcl
