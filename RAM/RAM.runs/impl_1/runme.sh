...
HD_PWD='/home/danielmartins/Documentos/Universidade/CR/Projecto/RAM/RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RAMWrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RAMWrapper.tcl -notrace
